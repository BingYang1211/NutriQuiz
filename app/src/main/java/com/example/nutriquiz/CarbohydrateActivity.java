...
public class CarbohydrateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mediaPlayer = MediaPlayer.create(this, R.raw.carbohydrate_function);
    ...
    public void onClickNextBtn(View view) {
        Intent intent = new Intent(this, CarbohydrateActivity2.class);
        startActivity(intent);
    }

    public void onClickCarbohydrateFunction(View view) {
