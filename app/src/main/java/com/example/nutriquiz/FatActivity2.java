...
public class FatActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fat2);

        mediaPlayer = MediaPlayer.create(this, R.raw.fat_food);
    ...
    public void onClickFatFood(View view) {
