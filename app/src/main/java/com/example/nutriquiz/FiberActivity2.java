...
public class FiberActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fiber2);

        mediaPlayer = MediaPlayer.create(this, R.raw.fiber_food);
    ...
    public void onClickFiberFood(View view) {
