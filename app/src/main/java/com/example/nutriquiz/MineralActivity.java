...
public class MineralActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mediaPlayer = MediaPlayer.create(this, R.raw.mineral_function);
    ...
    public void onClickNextBtn(View view) {
        Intent intent = new Intent(this, MineralActivity2.class);
        startActivity(intent);
    }

    public void onClickMineralFunction(View view) {
