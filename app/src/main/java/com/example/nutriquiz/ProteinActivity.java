...
public class ProteinActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mediaPlayer = MediaPlayer.create(this, R.raw.protein_function);
    ...
    public void onClickNextBtn(View view) {
        Intent intent = new Intent(this, ProteinActivity2.class);
        startActivity(intent);
    }

    public void onClickProteinFunction(View view) {
