...
public class VitaminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mediaPlayer = MediaPlayer.create(this, R.raw.vitamin_function);
    ...
    public void onClickNextBtn(View view) {
        Intent intent = new Intent(this, VitaminActivity2.class);
        startActivity(intent);
    }

    public void onClickVitaminFunction(View view) {
